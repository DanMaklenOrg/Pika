...
public partial class PikaLangBaseVisitor<Result> : AbstractParseTreeVisitor<Result>, IPikaLangVisitor<Result> {
	...
	/// <summary>
	/// Visit a parse tree produced by <see cref="PikaLangParser.domainDecl"/>.
	/// <para>
	/// The default implementation returns the result of calling <see cref="AbstractParseTreeVisitor{Result}.VisitChildren(IRuleNode)"/>
	/// on <paramref name="context"/>.
	/// </para>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitDomainDecl([NotNull] PikaLangParser.DomainDeclContext context) { return VisitChildren(context); }
	/// <summary>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitNamedIdentifier([NotNull] PikaLangParser.NamedIdentifierContext context) { return VisitChildren(context); }
}
} // namespace Pika.PikaLang
